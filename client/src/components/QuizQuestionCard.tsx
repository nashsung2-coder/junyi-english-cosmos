...
export default function QuizQuestionCard({
  ...
  return (
    <article className="rounded-3xl border border-white/10 bg-gradient-to-br from-white/[0.055] to-white/[0.015] p-5 shadow-2xl md:p-8">
      ...
      <h2 className="mt-3 text-xl font-semibold leading-relaxed md:text-2xl">{question.prompt}</h2>
      ...
      {checked && (
        <div className={`mt-5 rounded-2xl border p-4 text-sm leading-6 ${currentCorrect ? "border-emerald-300/30 bg-emerald-400/[0.06]" : "border-amber-300/30 bg-amber-400/[0.06]"}`}>
